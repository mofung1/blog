...
<!-- banner start -->
<div class="am-g am-g-fixed blog-fixed am-u-sm-centered blog-article-margin" style="margin-top: 0px;margin-bottom: 0px">
    ...
    <ul class="am-slides">
        <?php if(is_array($banner)): $i = 0; $__LIST__ = $banner;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                <img src="/blog<?php echo ($vo["picture"]); ?>">
...
<!--                     <p style="border:1px solid"><a href="" class="">continue reading</a></p> -->
    ...
    <img src="/blog/Public/Home/images/weixin.jpg" alt="about me" class="blog-entry-img" >
    <p>mofung1</p>
    <p>有一种落差是，你配不上自己的野心，也辜负了所受的苦难。</p>
</div>
...
<!-- 绿叶 -->
<!-- <script type="text/javascript">$.AutomLeafStart({leafsfolder:"/blog/Public/Home/images/yezi/",howmanyimgsare:8,initialleafs:10,maxYposition:-10,multiplyclick:true,multiplynumber:2,infinite:true,fallingsequence:4000});$("#botAgregar").on("click",function(){$.AutomLeafAdd({leafsfolder:"/blog/Public/Home/images/yezi/",add:8,})});</script> -->
</body>
</html>