      ...
      <article class="am-article blog-article-p">
        <div class="am-article-hd">
            ...
            <!--     <span><a href="#" class="blog-color"><?php echo ($data["author"]); ?> &nbsp;</a></span>-
                <span><a href="#"><?php echo (date("Y-m-d,H:i:s",$data['time'] )); ?></a></span> -->

                <span><a class="am-badge am-badge-primary am-round"><?php echo ($data["author"]); ?> &nbsp;</a></span>
                <span><a class="am-badge am-badge-secondary am-round"><?php echo (date("Y-m-d H:i:s",$data['time'] )); ?></a></span>
                <span><a class="am-badge am-badge-danger am-round"><?php echo ($data["visitor"]); ?></a></span>
        ...
        <blockquote><p><?php echo ($data["content"]); ?></footer></blockquote>
        </div>
      </article>
