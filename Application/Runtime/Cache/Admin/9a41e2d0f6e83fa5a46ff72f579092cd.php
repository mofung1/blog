...
<script type="text/javascript" src="/blog/Public/Admin/static/h-ui.admin/js/H-ui.admin.js"></script>
    ...
    <article class="page-container">
        <form action="" method="post" class="form form-horizontal" id="form_friend_link_add">
            <input type="hidden" class="input-text" value="<?php echo ($data["id"]); ?>" placeholder="" id="id" name="id">
            <!-- <input type="hidden" value="<?php echo ($data["link_logo"]); ?>" id="link_logo" name="link_logo"> -->
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input type="text" class="input-text" value="<?php echo ($data["url"]); ?>" placeholder="" id="url" name="url">
                        </div>
                    </div>
...
<!--                     <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <img class="product-thumb" height="200" width="" src="/blog/<?php echo ($data["link_logo"]); ?>">
                        </div>
                    </div>
...
<!--                     <div class="row cl">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <textarea name="desc" cols="" rows=""  class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true"  ><?php echo ($data["desc"]); ?></textarea>
        ...
        $(function(){
            ...
            $("#form_friend_link_add").validate({
                ...
                submitHandler:function(form){
                    ...
                    $.ajax({
                        url:"<?php echo U('Link/link_update_validate');?>",
                        type: "POST",
            ...
            //     $.ajax({
            //         url: "<?php echo U('Link/link_pic_upload');?>" ,
            //         type: 'POST',
            //         data: formData,
            //         async: false,
            //         cache: false,
