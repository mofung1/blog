...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 后台
        ...
        <div class="mt-20">
            <table class="table table-border table-bordered table-hover table-bg table-sort" style="l">
                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
                        ...
                        <td><img class="product-thumb" height="" width="" style="max-height: 200px;max-width: 200px; min-width: 100px; min-height:100px" src="/blog<?php echo ($vo["picture"]); ?>"></td>
                        <td><?php echo ($vo["content"]); ?></td>
                        <td><?php echo (date('Y-m-d',$vo["add_time"])); ?></td>
                        <td class="td-manage">
                            <a title="删除" href="javascript:;" onclick="carousel_del(this,<?php echo ($vo["id"]); ?>)" class="ml-5" style="text-decoration:none">删除</a>
                        </td>
    ...
    <script type="text/javascript">
        ...
        /*新增*/
        function add(id){
            var url = "<?php echo U('Carousel/carousel_add');?>?id="+id;
        ...
        function carousel_del(obj,id) {
            layer.confirm('确认要删除吗？',function(index){
                $.ajax({
                    url:"<?php echo U('Carousel/carousel_del_validate');?>",
                    type: 'POST',
                    dataType: 'json',
                    data: {id:id},
