    ...
    <article class="page-container">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row c1">
                    <div class="col-xs-6 col-sm-6 text-l">栏目名称：<?php echo ($data['catename']); ?></div>
               <!--      <div class="col-xs-6 col-sm-6 text-l">导&nbsp;&nbsp;航&nbsp;&nbsp;栏：<?php if($data['show_in_nav'] == 0): ?>不显示<?php elseif($data['show_in_nav'] == 1): ?> 显示<?php else: ?> --<?php endif; ?></div> -->
                    <div class="col-xs-6 col-sm-6 text-l">排&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;序：<?php echo ($data['sort']); ?></div>
                    
                    
                    <div class="col-xs-6 col-sm-6 text-l">添加时间：<?php echo (date('Y-m-d',$data['add_time'])); ?></div>
