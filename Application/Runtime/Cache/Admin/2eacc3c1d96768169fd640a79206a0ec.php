...
<script type="text/javascript" src="/blog/Public/Admin/static/h-ui.admin/js/H-ui.admin.js"></script>
    ...
    <article class="page-container">
        ...
        <form class="form form-horizontal" id="form_article_edit" method='post' enctype="multipart/form-data">
            <input type="" hidden="hidden" name="id" value="<?php echo ($data['id']); ?>">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
                            <select id="menu_id" name="menu_id" class="select" >
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option  <?php if($vo['catename']==$data['cate']) echo("selected");?> value="<?php echo ($vo['id']); ?>" ><?php echo ($vo['catename']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                            </span>
                        </div>
                    </div>
            ...
            <div class="panel panel-default mt-20">
                ...
                <div class="panel-body">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <input  name="image[]" class="form-control" value="<?php echo ($data['pic']); ?>" type="file" accept="image/png,image/jpeg,image/gif">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-9">
                            <script id="editor" name="content" type="text/plain" style="width:100%;height:200px;"><?php echo ($data['content']); ?></script>
                        </div>
                    </div>
        ...
        $(function(){
            ...
            $("#form_article_edit").validate({
                ...
                submitHandler:function(form){
                    ...
                    $.ajax({
                        url:"<?php echo U('Article/article_update_validate');?>",
                        type: "POST",
                        data: formData,
                        contentType: false,
                        processData: false,
